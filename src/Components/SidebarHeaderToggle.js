...
<div className="container-fluid">
  ...
  {/* <img
    src="https://static.vecteezy.com/system/resources/thumbnails/016/145/511/small/blue-green-gradient-abstract-illustration-logo-vector.jpg"
    style={{  width:'10%',height:'10%' }}
    alt="Vendor Connect logo"
  /> */}
...
{/* style={{animation: 'rollingleft 2s linear infinite'}} */}
            ...
            {isOpen?
              ...
              <div className="card-icon rounded-circle d-flex align-items-center justify-content-left" style={{marginTop:"50%", marginLeft:'10px',cursor: "pointer"}}  onClick={() => {
                        localStorage.clear() 
